...
unsafe extern "C" fn ryu_final_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
    if !VarModule::is_flag(fighter.module_accessor, ryu::instance::flag::SKIP_FINAL_PROX_CHECK) {
...
unsafe extern "C" fn ryu_final_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    VarModule::off_flag(fighter.module_accessor, ryu::instance::flag::SKIP_FINAL_PROX_CHECK);
