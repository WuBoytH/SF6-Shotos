...
unsafe extern "C" fn ryu_attack_lw3_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install(agent: &mut smashline::Agent) {
    agent.status(smashline::Pre, *FIGHTER_STATUS_KIND_ATTACK_LW3, ryu_attack_lw3_pre);
    agent.status(smashline::Main, *FIGHTER_STATUS_KIND_ATTACK_LW3, ryu_attack_lw3_main);
}