...
unsafe extern "C" fn ryu_attack_hi3_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install(agent: &mut smashline::Agent) {
    agent.status(smashline::Pre, *FIGHTER_STATUS_KIND_ATTACK_HI3, ryu_attack_hi3_pre);
